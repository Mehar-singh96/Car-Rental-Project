    ...
    2: [function (a, b, c) {
        ...
        ! function (a, c) {
            ...
            return v = function (a) {
                ...
                var c, d, e;
                return "object" == typeof a && "month" in a && (e = a, a = e.month, b = e.year), a && b ? (a = String(a).trim(), b = String(b).trim(), /^\d+$/.test(a) && /^\d+$/.test(b) && a >= 1 && 12 >= a ? (2 === b.length && (b = 70 > b ? "20" + b : "19" + b), 4 !== b.length ? !1 : (d = new Date(b, a), c = new Date, d.setMonth(d.getMonth() - 1), d.setMonth(d.getMonth() + 1, 1), d > c)) : !1) : !1
                ...
                var c, d, e, f;
                return b = b.replace(/\D/g, ""), (c = a(b)) ? (e = c.length[c.length.length - 1], b = b.slice(0, e), c.format.global ? null != (f = b.match(c.format)) ? f.join(" ") : void 0 : (d = c.format.exec(b), null != d ? (d.shift(), d = d.filter(Boolean), d.join(" ")) : void 0)) : b
