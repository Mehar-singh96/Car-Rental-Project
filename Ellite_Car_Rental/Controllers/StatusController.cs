...
namespace Ellite_Car_Rental.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Status_Pay")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Status_Pay")] Status status)
        {
            if (ModelState.IsValid)
            {
